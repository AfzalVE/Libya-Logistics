...
export default function Login() {
  ...
  return (
    ...
    >
      {/* Intricate Animated Background Patterns */}
      <div className="clay-login-bg-pattern" />

      <div
        className="grid grid-cols-1 lg:grid-cols-2 w-full max-w-[1040px] bg-[var(--clay-surface-soft)] rounded-[var(--r-xl)] border-[1.5px] border-clay-hairline overflow-hidden shadow-[0_8px_32px_rgba(10,10,10,0.04)]"
        style={{ zIndex: 1 }}
      >
        ...
        <div className="hidden lg:flex flex-col justify-between relative overflow-hidden bg-clay-teal text-white p-12">
          ...
          <div style={{ margin: "48px 0", zIndex: 1 }}>
            ...
            >
              An interactive workflow orchestrator connecting Super Admins,
              operators booking shipments at origin, and managers routing
              parcels to their final delivery point.
            </p>
              ...
              {[
                {
                  ...
                  desc: "Initialize warehouses and user roles.",
                },
                {
                  title: "Operator Booking",
                  desc: "Book and store shipments locally.",
                },
                {
                  title: "Manager Operations",
                  desc: "Dispatch, track in transit, receive, and complete pickup.",
                },
              ].map((step, idx) => (
                <div
                  key={idx}
          ...
          >
            <path
              d="M0,120 L80,50 L160,100 L240,30 L320,90 L400,40 L400,120 Z"
              fill="var(--clay-ochre)"
            />
            <path
              d="M0,120 L100,70 L200,110 L280,60 L360,100 L400,70 L400,120 Z"
              fill="var(--clay-pink)"
            />
          </svg>
        </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              {demoAccounts.map((acc) => (
                <button
                  ...
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.borderColor = "var(--clay-ink)")
                  }
                  onMouseLeave={(e) =>
                    (e.currentTarget.style.borderColor = "var(--clay-hairline)")
                  }
                >
                  <span
                    style={{
